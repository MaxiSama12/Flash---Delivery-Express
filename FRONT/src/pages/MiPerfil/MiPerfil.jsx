    ...
    <div className="perfil-container">
      <div className="perfil-card">
        ...
        <div className="perfil-info">
          <p><strong>Nombre:</strong><div className="bloque-perfil">{usuario.nombre}</div></p>
          <p><strong>Email:</strong><div className="bloque-perfil">{usuario.email}</div></p>
          <p><strong>Teléfono:</strong><div className="bloque-perfil">{usuario.telefono}</div></p>

          {usuario.direccion && <p className="mb-1"><strong>Dirección:</strong> <div className="bloque-perfil">{usuario.direccion}</div></p>}
          {usuario.rol === "repartidor" && usuario.vehiculo && (
            <p><strong>Vehículo:</strong> <div className="bloque-perfil"> {usuario.vehiculo}</div></p>
          )}
          <p><strong>Rol:</strong> <div className="bloque-perfil">{usuario.rol.charAt(0).toUpperCase() + usuario.rol.slice(1)}</div></p>
          <button
